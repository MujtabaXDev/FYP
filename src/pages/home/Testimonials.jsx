          ...
          <div className="text-left md:w-4/s">
            ...
            <div className=" ml-2">
              <blockquote className="text-base  font-medium text-secondary my-5 leading-[30px] ">
                "Exceptional service and mouthwatering dishes! MRKing has
                redefined convenience without compromising on flavor. The
                diverse menu caters to all tastes, and the delivery is always
                prompt. Our family's favorite for online food orders in Sri
                Lanka!"
              </blockquote>
