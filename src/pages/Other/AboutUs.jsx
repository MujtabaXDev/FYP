const AboutUs = () => {
  return (
    <div className=" bg-white h-screen menu-background mt-100">
      <div className="section-container  ">
        <div className=" flex flex-col md:flex-row-reverse justify-center h-screen items-center gap-6">
          {/* Left side */}

          <div className="md:w-3/5 space-y-7  text-black bg-white p-4 rounded-2xl mt-32">
