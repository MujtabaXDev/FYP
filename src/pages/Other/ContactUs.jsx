        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <textarea
              ...
              className="w-full px-4 py-2 border shadow-xl bg-simpleLightYellow rounded-md focus:outline-none focus:ring-2 focus:ring-slate-400"
              rows="5"
              required
            ></textarea>
          </div>
          <div className="text-center">
            <button
              type="submit"
              className="shadow-xl bg-teal-600/70 text-base rounded-xl text-slate-700 px-8 py-3 hover:bg-teal-400 transition duration-300"
            >
              Submit
            </button>
          </div>
